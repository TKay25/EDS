                                            ...
                                            if message.get("type") == "interactive":
                                                ...
                                                if selected_option == "book_ticket":
                                                    ...
                                                    try:
                                                        ...
                                                        for row in rows:
                                                            dep, arr, time_, paymethod, fare, ecocashnum, pollurl, status = row

                                                            if (
                                                                any(field is None or str(field).strip() == '' for field in [dep, arr, time_, paymethod, fare, ecocashnum, pollurl])
